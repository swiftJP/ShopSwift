    ...
    <div class="fashion-intro">
        <div class="order-message">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h1>Primark Loughborough</h1>
                        <br>
                        <h4>39-40 Market Place, Loughborough LE11 3EB | Deliveries until 17:00 |</h4>
                    </div>
                    ...
                    <div class="col-xs-5 col-sm-3">
                        ...
                        <div class="whats-hot">
                            <div class="row">
                                <div class="col-md-12">
                                    <div>
                                        <div><img class="img-responsive" src="{{asset('images/yellow-shirt.jpg')}}"/>
                                        </div>
                                        <div class="caption">
                                            <h4 class="text-center">Yellow Velvet Shirt</h4>
                                        </div>
                                    </div>
                                </div>
