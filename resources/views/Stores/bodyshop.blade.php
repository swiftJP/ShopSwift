                    ...
                    <div class="col-xs-7 col-sm-9">
                        <div>
                            ...
                            <form action="{{url('send')}}" method="post">
                                ...
                                <input type='hidden' name='delivery_store' value="bodyshop"/>
                        ...
                        <div class="whats-hot">
                            <div class="row">
                                <div class="col-md-12">
                                    <div>
                                        <div>
                                            <img class="img-responsive" src="{{asset('images/Summer-box.jpg')}}"/>
                                        </div>
                                        <div class="caption">
                                            <h4 class="text-center"><br><br><br><br>Summer Feel Good Box</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
