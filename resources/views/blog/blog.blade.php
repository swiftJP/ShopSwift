        ...
        <div class="row">
            <div class="col-lg-4 col-xs-6">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption text-center">
                        ...
                        <h3 class="blog-author">Tyra Edmund</h3>
                        <h5 class="blog-date"><i>Aug 1</i></h5>
                        <h5 class="pull-right blog-time">(2 min<span class="glyphicon glyphicon-time"></span>)</h5>
            ...
            <div class="col-lg-4 col-xs-6">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption text-center">
                        <h3><strong>How startups like ShopSwift help you to save time</strong></h3>
                        <hr class="blog-hr">
                        <h6>Nowadays, pretty much everyone has interacted with an on demand service without even realizing it. The on-demand economy encompasses ...</h6>
                        ...
                        <h5 class="pull-right blog-time">(4 min<span class="glyphicon glyphicon-time"></span>)</h5>
                    </div>
                </div>
            </div>
        </div>
